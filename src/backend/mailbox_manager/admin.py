...
class MailDomainAdmin(admin.ModelAdmin):
    ...
    @admin.action(description=_("Export a list of select domains support email"))
    def export_domains_contact_list(self, request, queryset):  # pylint: disable=unused-argument
        """Admin action to export."""
